...
public class LanguageDB {
    ...
    public static String noPermission = "§4§lDu hast dafür nicht die Berechtigung!";
    public static String alreadyLoaded = "§a§lDeine Spielerdaten wurden bereits erfolgreich geladen!";
    public static String notOnline = "§c§lSpieler ist nicht online!";
    public static String changeTime = "§a§lZeit geändert zu: §e%s!";
    public static String changeWeather = "§a§lWetter geändert zu: §e%s!";
    ...
    public static String giveError = "§c§lBenutze: §e/give <Playername> <ItemID/Name> <Anzahl> <Data>";
    public static String timeError = "§c§lBenutze: §e/time <TimeName>";
    public static String timeAvailable = "§c§lVerfügbar: §eDAY, NIGHT, EVENING, MORNING";
    public static String weatherError = "§c§lBenutze: §e/weather <WeatherName>";
