package de.linzn.xeonInventory.listener;
...
public class BukkitEvents extends SQLInject implements Listener {
	...
	public void onDamage(EntityDamageByEntityEvent event) {
		if (!CookieApi.isPlayerHashLoadet(event.getDamager().getUniqueId())
	...
	public void onAllDamage(EntityDamageEvent event) {
		if (event.getEntity() instanceof Player) {
			if (!CookieApi.isPlayerHashLoadet(event.getEntity().getUniqueId())
